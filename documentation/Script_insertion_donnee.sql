...
INSERT INTO
    Utilisateur (
        nom, courriel, mdp_hashed, privilege, date_naiss, desc_public, id_image
    )
VALUES (
        'john', 'john@example.com', 'hashed_password', 0, '2000-01-01', 'J\'adore les cocktails', 1
    );
...
VALUES (
        'Jane Doe', 'jane@example.com', 'hashed_password', 0, '2000-01-02', 'J\'adore préparer des cocktails', 2
    );
...
INSERT INTO
    Cocktail (
        nom, desc_cocktail, preparation, nb_like, type_verre, classique, profil_saveur, id_utilisateur, id_image, id_alcool
    )
VALUES (
        'Mojito', 'Cocktail rafraîchissant', 'Mélanger tous les ingrédients', 0, 'Verre long', 1, 'Sucré', 1, 1, 2
    );
...
VALUES (
        'Gin Tonic', 'Cocktail classique', 'Mélanger gin et tonic', 0, 'Verre long', 1, 'Amer', 2, 2, 3
    );

-- Insertion des données dans la table Ingredient_Cocktail
INSERT INTO
    Ingredient_Cocktail (
        quantite, unite, id_ingredient, id_cocktail
    )
VALUES (1, 'pièce', 2, 1);

INSERT INTO
    Ingredient_Cocktail (
        quantite, unite, id_alcool, id_cocktail
    )
VALUES (2, 'Oz', 1, 1);
...
INSERT INTO
    ingredient_cocktail (
        quantite, unite, ingredient_autre, id_cocktail
    )
VALUES (2, 'pièce', 'coriandre', 2);

-- Insertion des données dans la table Commentaire
INSERT INTO
    Commentaire (
        contenu, nb_like, id_utilisateur, id_cocktail
    )
VALUES ('Super cocktail !', 0, 1, 1);
